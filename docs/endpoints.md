...
| `Instance` | `/resources/instance/session-control-switch` | `SwitchSessionControl` | `[]SessionControlSwitchFailure` |
...
| `Instance` | `/resources/instance/data-copy` | `CopyInstanceData` | `[]DataCopyResponse` |
...
| `Instance` | `/resources/instance/expire-time-increase` | `IncreaseExpireTime` | `ExpireTimeResponse` |
| `Instance` | `/resources/instance/expire-time-update` | `UpdateExpireTime` | `ExpireTimeResponse` |
| `Instance` | `/resources/instance/export-ip` | `ExportIP` | `[]ExportIPResult` |
...
| `App` | `/resources/app/new-version` | `NewAppVersion` | `AppVersionResponse` |
| `App` | `/resources/app/upgrade` | `UpgradeApp` | `AppVersionResponse` |
...
| `Distribute` | `/distribute/task/query-flow` | `QueryFlow` | `QueryFlowResponse` |
...
| `Monitor` | `/monitor/network-bandwidth/list` | `ListNetworkBandwidth` | `NetworkBandwidthStats` |
...
| `Monitor` | `/resources/instance-app-monitor-info` | `GetInstanceAppMonitorInfo` | `InstanceAppMonitorInfo` |
...
| `Tag` | `/resources/instance-tag/save` | `SaveInstanceTag` | `SaveInstanceTagResponse` |
...
| `Image` | `/resources/instance-base-image/list` | `ListBaseImages` | `Page[BaseImageInfo]` |
| `Image` | `/resources/instance-image/list` | `ListInstanceImages` | `Page[InstanceImageInfo]` |
